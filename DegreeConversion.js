...
let option = parseInt(
  prompt("Enter option: 1. Celsius to Fahreinheit 2. Fahreinheit to Celsius : ")
);
switch (option) {
  case 1:
    let celsius = parseFloat(
      prompt("Enter the temperature range within 0*C to 100*C: ")
    );
    ...
    break;
  case 2:
    let fahreinheit = parseFloat(
      prompt("Enter the temperature range within 32*F to 212*F: ")
    );
